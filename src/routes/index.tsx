    ...
    <section className="relative overflow-hidden cursor-default min-h-screen min-h-[100dvh]">
      ...
      <div className="w-full h-full absolute inset-0 flex flex-col items-center justify-center text-center">
        <div style={{ position: 'relative', zIndex: 2 }} className="w-full flex flex-col items-center px-5 sm:px-6 py-16">
          ...
          >
            We're building India's campus venture studio network, turning students into funded founders, one cohort at a time.
          </motion.p>
  ...
  return (
    <section className="max-w-[1200px] mx-auto px-6 md:px-10 py-20">
      <AnimateIn className="text-center">
        ...
        <p className="text-on-surface-variant max-w-xl mx-auto mb-16">From campus to capital, every stage is structured and every founder is supported.</p>
      </AnimateIn>
        ...
        {[
          {
            ...
            desc: "The foundational layer of Beacon Indica, embedded right inside universities and colleges. It's a high-performance environment where students explore, build, and validate startup ideas while keeping up with their academic journey.",
            bullets: ['A structured startup environment', 'Problem identification and validation', 'Mentors and peer builders', 'Idea development and experimentation'],
            cta: 'Apply to Genesis', href: '/programs#genesis',
          },
          {
            num: '02', name: 'Fellowship', tag: 'Invite Only',
            desc: 'This is for founders who are serious and already showing early signs of execution. Here the focus shifts from exploration to building companies that investors actually want to back.',
            bullets: ['Up to ₹5 Lakhs in funding', 'MVP and technical support', 'Marketing and GTM strategy', 'Legal and compliance support'],
            cta: 'Apply to Fellowship', href: '/programs#fellowship',
          },
          {
            num: '03', name: 'Accelerator', tag: null,
            desc: 'For startups that are ready to grow and raise money. Everything here is about scaling fast, positioning well, and showing up investor-ready.',
            bullets: ['A curated investor network', 'Fundraising support', 'Business scaling frameworks', 'Strategic partnerships'],
      ...
      <div className="grid md:grid-cols-12 gap-8 items-center">
        <AnimateIn className="md:col-span-4 mb-8 md:mb-0">
          ...
          <p className="text-on-surface-variant mb-8">
            Each Beacon studio runs on the ground with a 10-person student leadership team driving it.
          </p>
          <motion.div
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
