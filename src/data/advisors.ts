...
export const advisors: Advisor[] = [
  {
    ...
    shortBio:
      "He founded SEND App, a 10-minute grocery delivery service in Australia that raised around $23M at a time when Blinkit and Zepto were still single-city operations. He also founded VAttendance, India's first mobile-based attendance system, and is currently building Rentfree and Freehold for the Australian proptech market.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio:
      "A technology leader and engineering executive with deep expertise in building and scaling product teams. He brings hands-on CTO experience across enterprise and growth-stage companies.",
    fullBio: [
